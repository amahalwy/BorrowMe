    ...
    return (
      <div className="main">
        ...
        <div className="main-footer">
          <a className="main-git-links" href="https://github.com/amahalwy/BorrowMe">
            <div className="main-git-links-container">
              <img className="main-git-logo" src="https://www.iconsdb.com/icons/preview/white/github-9-xxl.png" alt="github-logo"/>
              <h3>Project Repo</h3>
            </div>
          </a>
          <a className="main-git-links ahmed-git-link" href="https://github.com/amahalwy">
            <div className="main-git-links-container">
              <img className="main-git-logo" src="https://www.iconsdb.com/icons/preview/white/github-9-xxl.png" alt="github-logo"/>
              <h3>Ahmed El Mahallawy</h3>
            </div>
          </a>
          <a className="main-git-links ayce-git-link" href="https://github.com/aycelacap">
            <div className="main-git-links-container">
              <img className="main-git-logo" src="https://www.iconsdb.com/icons/preview/white/github-9-xxl.png" alt="github-logo"/>
              <h3>Ayce Lacap</h3>
            </div>
          </a>
          <a className="main-git-links nate-git-link" href="https://github.com/n8gallagher">
            <div className="main-git-links-container">
              <img className="main-git-logo" src="https://www.iconsdb.com/icons/preview/white/github-9-xxl.png" alt="github-logo"/>
              <h3>Nate Gallagher</h3>
            </div>
          </a>
          <a className="main-git-links sean-git-link" href="https://github.com/seanscott23">
            <div className="main-git-links-container">
              <img className="main-git-logo" src="https://www.iconsdb.com/icons/preview/white/github-9-xxl.png" alt="github-logo"/>
              <h3>Sean Scott</h3>
            </div>
